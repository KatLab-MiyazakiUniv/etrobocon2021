...
namespace etrobocon2021_test {
  ...
  TEST(planBingoRouteTest, planBingoRoute_carryRoute)
  {
    ...
    expected_route[1].push_back(std::make_pair(route_1, Direction::S));
    ...
    route_3 = { 1, 6 };
    coordinate_goal = { 0, 6 };
    expected_route[2].push_back(std::make_pair(coordinate_start, Direction::S));
    expected_route[2].push_back(std::make_pair(route_1, Direction::W));
    ...
    route_5 = { 3, 0 };
    coordinate_goal = { 2, 0 };
    expected_route[5].push_back(std::make_pair(coordinate_start, Direction::NW));
    expected_route[5].push_back(std::make_pair(route_1, Direction::W));
    expected_route[5].push_back(std::make_pair(route_2, Direction::W));
    ...
    route_3 = { 1, 2 };
    coordinate_goal = { 0, 2 };
    expected_route[6].push_back(std::make_pair(coordinate_start, Direction::SW));
    ...
    route_7 = { 6, 1 };
    coordinate_goal = { 6, 0 };
    expected_route[7].push_back(std::make_pair(coordinate_start, Direction::SE));
    expected_route[7].push_back(std::make_pair(route_1, Direction::E));
    expected_route[7].push_back(std::make_pair(route_2, Direction::E));
    expected_route[7].push_back(std::make_pair(route_3, Direction::E));
    expected_route[7].push_back(std::make_pair(route_4, Direction::E));
    expected_route[7].push_back(std::make_pair(route_5, Direction::N));
