...
namespace etrobocon2021_test {
  ...
  TEST(MotionConverter, fullBingo)
  {
    ...
    expectedMotion.insert(expectedMotion.end(),
                          { MOTION::TARC, MOTION::TARC, MOTION::BC, MOTION::TR, MOTION::BC });
    motionConverter.convertToMotion(minRoute);
    std::vector<MOTION> actualMotion = motionPerformer.motionLog;
    ...
    expectedMotion.insert(expectedMotion.end(), { MOTION::PSETL });
    motionConverter.convertToMotion(minRoute);
    actualMotion = motionPerformer.motionLog;
    EXPECT_EQ(expectedMotion, actualMotion);
    ...
    minRoute = route.calculateRoute(start, goal);
    expectedMotion.insert(expectedMotion.end(),
                          { MOTION::TARC, MOTION::TARC, MOTION::BC, MOTION::TL, MOTION::BC });
    motionConverter.convertToMotion(minRoute);
    actualMotion = motionPerformer.motionLog;
    EXPECT_EQ(expectedMotion, actualMotion);
    ...
    goal = { 1, 1 };
    minRoute = route.calculateRoute(start, goal);
    expectedMotion.insert(expectedMotion.end(), { MOTION::TSETL });
    motionConverter.convertToMotion(minRoute);
    actualMotion = motionPerformer.motionLog;
    EXPECT_EQ(expectedMotion, actualMotion);
    ...
    minRoute = route.calculateRoute(start, goal);
    expectedMotion.insert(expectedMotion.end(),
                          { MOTION::TARC, MOTION::BC, MOTION::ST, MOTION::BC });
    motionConverter.convertToMotion(minRoute);
    actualMotion = motionPerformer.motionLog;
    EXPECT_EQ(expectedMotion, actualMotion);
    ...
    minRoute = route.calculateRoute(start, goal);
    expectedMotion.insert(expectedMotion.end(),
                          { MOTION::TARC, MOTION::TARC, MOTION::BC, MOTION::TSETL });
    motionConverter.convertToMotion(minRoute);
    actualMotion = motionPerformer.motionLog;
    EXPECT_EQ(expectedMotion, actualMotion);
    ...
    minRoute = route.calculateRoute(start, goal);
    expectedMotion.insert(expectedMotion.end(),
                          { MOTION::TAC, MOTION::TAC, MOTION::TAC, MOTION::BC });
    motionConverter.convertToMotion(minRoute);
    actualMotion = motionPerformer.motionLog;
    EXPECT_EQ(expectedMotion, actualMotion);
    robot.setDirection(Direction::S);  //走行体の向きを更新
    ...
    minRoute = route.calculateRoute(start, goal);
    expectedMotion.insert(expectedMotion.end(),
                          { MOTION::TAC, MOTION::TAC, MOTION::BC, MOTION::ST, MOTION::BC });
    motionConverter.convertToMotion(minRoute);
    actualMotion = motionPerformer.motionLog;
    EXPECT_EQ(expectedMotion, actualMotion);
    robot.setDirection(Direction::W);  //走行体の向きを更新
    ...
    goal = { 1, 5 };
    minRoute = route.calculateRoute(start, goal);
    expectedMotion.insert(expectedMotion.end(), { MOTION::PSETR });
    motionConverter.convertToMotion(minRoute);
    actualMotion = motionPerformer.motionLog;
    EXPECT_EQ(expectedMotion, actualMotion);
    ...
    goal = { 3, 5 };
    minRoute = route.calculateRoute(start, goal);
    expectedMotion.insert(expectedMotion.end(), { MOTION::TAC, MOTION::TAC, MOTION::BC, MOTION::TR,
                                                  MOTION::BC, MOTION::TSETL });
    motionConverter.convertToMotion(minRoute);
    actualMotion = motionPerformer.motionLog;
    EXPECT_EQ(expectedMotion, actualMotion);
    ...
    goal = { 6, 0 };
    minRoute = route.calculateRoute(start, goal);
    expectedMotion.insert(expectedMotion.end(), { MOTION::TAC, MOTION::BC });
    motionConverter.convertToMotion(minRoute);
    actualMotion = motionPerformer.motionLog;
    EXPECT_EQ(expectedMotion, actualMotion);
    robot.setDirection(Direction::N);  //走行体の向きを更新
    ...
    minRoute = route.calculateRoute(start, goal);
    expectedMotion.insert(expectedMotion.end(),
                          { MOTION::TAC, MOTION::TAC, MOTION::TAC, MOTION::TAC, MOTION::BC,
                            MOTION::TR, MOTION::BC, MOTION::ST, MOTION::BC, MOTION::TSETL });
    motionConverter.convertToMotion(minRoute);
    motionConverter.convertToMotion(minRoute);
    actualMotion = motionPerformer.motionLog;
    EXPECT_EQ(expectedMotion, actualMotion);
